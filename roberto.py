...
find1 = "➤Контракт: Раскрытие роли\nФаза активации: любая\nДействие контракта: Ты заключишь контракт с синьором " \
        "Костей, и единоразово он раскроет тебе роль человека, на которого ты укажешь.\nДополнительно: Активируется " \
...
close1 = "➤Контракт: Подмена роли\nФаза активации: любая\nДействие контракта: Ты заключишь контракт с синьором " \
         "Артёмом, и единоразово он подменит ваше досье в случае проверки.\nДополнительно: Можно использовать как на " \
         ...
         "суток. "
immune1 = "➤Контракт: Иммунитет\nФаза активации: дневная\nДействие контракта: Ты заключишь контракт с синьорой Мел, " \
...
vote1 = "➤Контракт: Дополнительные голоса\nФаза активации: дневная\nДействие контракта: Ты заключишь контракт с " \
        "синьором Егором, и единоразово он внесёт правки в листы голосования, добавив шесть голосов к твоему " \
        "голосу.\nДополнительно: Голоса можно активировать только на того игрока, против которого вы голосовали. "
gag1 = "➤Контракт: Кляп\nФаза активации: дневная\nДействие контракта: Ты заключишь контракт с доном Энди, " \
...
jour1 = "➤Контракт: Частное расследование\nФаза активации: дневная\nДействие контракта: ты заключишь контракт с " \
        "синьорином Граниным, и единоразово она позволит тебе выпустить дополнительную статью " \
...
seek1 = "➤Контракт: Слежка\nФаза активации: любая\nДействие контракта: ты заключишь контракт с синьорой Яной, " \
        "и единоразово она устроит профессиональную слежку за игроком, на которого ты укажешь.\nДополнительно: " \
...
for event in longpoll.listen():
    if event.type == VkEventType.MESSAGE_NEW and event.to_me and event.text:
        # admins = [313354983]
        admins = [252868342, 501779741, 501816721, 554492466, 554485610, 547692069, 501811751, 547691077, 547692727]
