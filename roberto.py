...
vote1 = "Отличный выбор, amico! Поздравляю тебя с успешным началом смены. Свой отряд знаешь? Отлично. Можешь забирать и идти по делам:\n\n➤Контракт: Дополнительные голоса\nФаза активации: дневная\nКоличество контрактов в рандоме: 2 шт.\nДействие контракта: ты заключишь контракт с синьором Питером, и единоразово он внесёт правки в листы голосования, добавив шесть голосов к твоему голосу.\nДополнительно: голоса можно активировать только на того игрока, против которого вы голосовали."
curse1 = "Отличный выбор, amico! Поздравляю тебя с успешным началом смены. Свой отряд знаешь? Отлично. Можешь забирать и идти по делам:\n\n➤Контракт: Проклятие\nФаза активации: любая\nКоличество контрактов в рандоме: 2 шт.\nДействие контракта: ты заключишь контракт с синьором Тропой, и единоразово он нашлёт проклятие на того, кто перешёл тебе дорогу.\nДополнительно: проклятый игрок умирает вместе с Ведьмой. О проклятии игроку не сообщается."
pure1 = "Отличный выбор, amico! Поздравляю тебя с успешным началом смены. Свой отряд знаешь? Отлично. Можешь забирать и идти по делам:\n\n➤Контракт: Очищение\nФаза активации: любая\nКоличество контрактов в рандоме: 1 шт.\nДействие контракта: ты заключишь контракт с синьориной Киреной, и единоразово она снимет с выбранного тобой игрока порчу и проклятье, воспользовавшись фамильным заклинанием, доставшимся ей от бабушки-ведуньи.\nДополнительно: выбранный игрок наделяется иммунитетом как от уже наложенного проклятия, так и от возможности быть проклятым."
...
for event in longpoll.listen():
    if event.type == VkEventType.MESSAGE_NEW and event.to_me and event.text:
        ...
        if rm == "аукцион":
            ...
            send_button(sender, "Хочешь знать, что у меня есть ещё? Конечно-конечно, выбирай:")
        elif rm[-7:] == "– взять":
            false = 0
            k = 0
