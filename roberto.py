intro = "У тебя была всего одна попытка выбрать. Надеюсь, ты знаешь, что делаешь...\n\n➤Контракт: "
...
def giveaway(obj, obj0, obj1, obj3):
    obj.append(sayer_name)
    ids.append(sender)
    attachments = obj3
    obj1 = intro + obj1
    deal(sender, attachments, obj1)
    obj0 -= 1
...
for event in longpoll.listen():
    if event.type == VkEventType.MESSAGE_NEW and event.to_me and event.text:
        ...
        if rm == "аукцион":
            ...
            send_button(sender, "(РАБОЧЕЕ) ммм чулан давайте туда зайдём ого а там:")
        elif rm == "список":
            for i in range(len(admins)):
                if sender == admins[i]:
                    itog = finally_end()
            ...
            if false != 1:
                ...
                if rm == "иммунитет":
                    if immune0 == 0:
                        ...
                        giveaway(immune, immune0, immune1, immune3)
                        count += 1
                elif rm == "слежка":
                    if seek0 == 0:
                        runout(sender)
                    else:
                        giveaway(seek, seek0, seek1, seek3)
                        count += 1
                elif rm == "убийство":
                    if kill0 == 0:
                        runout(sender)
                    else:
                        giveaway(kill, kill0, kill1, kill3)
                        count += 1
                elif rm == "исцеление":
                    if heal0 == 0:
                        runout(sender)
                    else:
                        giveaway(heal, heal0, heal1, heal3)
                        count += 1
                elif rm == "бутылка виски":
                    if whisky0 == 0:
                        runout(sender)
                    else:
                        giveaway(whisky, whisky0, whisky1, whisky3)
                        count += 1
                elif rm == "бондаж":
                    if ropes0 == 0:
                        runout(sender)
                    else:
                        giveaway(ropes, ropes0, ropes1, ropes3)
                        count += 1
                elif rm == "частное расследование":
                    if detect0 == 0:
                        runout(sender)
                    else:
                        giveaway(detect, detect0, detect1, detect3)
                        count += 1
                elif rm == "афера":
                    if rumour0 == 0:
                        runout(sender)
                    else:
                        giveaway(rumour, rumour0, rumour1, rumour3)
                        count += 1
                elif rm == "раскрытие роли":
                    if find0 == 0:
                        runout(sender)
                    else:
                        giveaway(find, find0, find1, find3)
                        count += 1
                elif rm == "подмена роли":
                    if close0 == 0:
                        runout(sender)
                    else:
                        giveaway(close, close0, close1, close3)
                        count += 1
                elif rm == "проклятие":
                    if curse0 == 0:
                        runout(sender)
                    else:
                        giveaway(curse, curse0, curse1, curse3)
                        count += 1
                elif rm == "дополнительные голоса":
                    if vote0 == 0:
                        runout(sender)
                    else:
                        giveaway(vote, vote0, vote1, vote3)
                        count += 1
                elif rm == "очищение":
                    if pure0 == 0:
                        runout(sender)
                    else:
                        giveaway(pure, pure0, pure1, pure3)
                        count += 1
                else:
