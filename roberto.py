...
gag1 = "➤Контракт: Кляп\nФаза активации: дневная\nДействие контракта: Ты заключишь контракт с синьором Элиасом, " \
       ...
       "возможности общаться текстовыми сообщениями, в его распоряжении будут только смайлики и стикеры. Активируется " \
       "в дневную фазу, но действие оказывает на ночную. Контракт не забирает возможность сделать ход роли. \nВ случае " \ 
...
vodka1 = '➤Предмет: Бутылка водки\nФаза активации: ночная\nОписание: Только в Лавке Роберто вам доступна легендарная ' \
         ...
         'выбранного игрока активная дневная роль, он также не сможет совершить свой ход.\nВ случае нарушений условий ' \
         'предмета игрок получает 1 плеть, исключается из рандома контрактов, а его контракт уходит тому, кто использовал ' \
         'предмет. Если у игрока на руках нет контракта, он получает 2 плети. '
...
for event in longpoll.listen():
    if event.type == VkEventType.MESSAGE_NEW and event.to_me and event.text:
        ...
        if rm == "аукцион":
            ...
            send_button(sender,
                        "Ты входишь в небольшой книжный магазин на окраине городка. Звоночек на двери издаёт вялый "
